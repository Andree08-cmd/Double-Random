...
1. **Financial Support:** A micro-grant of around **\$60 USD** to cover cloud server hosting (AWS/DigitalOcean) to run the mining process at scale.
2. **Hardware Collaboration:** Anyone willing to host and run the script on their own high-end hardware/servers.

If you want to support this project financially, cede server time, or discuss software engineering opportunities, please open an Issue or contact me directly on Discord!

---

## 📄 License
This project is open for community contributions, feedback, and educational use. Let's make Double Random Chess better for everyone!
